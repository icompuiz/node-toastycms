angular.module('toastycms.tpls', ['404', 'index', 'partials/common/footer', 'partials/common/ibox_tools', 'partials/common/navigation', 'partials/common/topnavbar', 'partials/main', 'partials/minor']);
...
angular.module("index", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("index",
    "<!DOCTYPE html><html><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><!-- Page title set in pageTitle directive--><title page-title=\"\"></title><!-- Bootstrap and Fonts--><link href=\"css/bootstrap.min.css\" rel=\"stylesheet\">    <link href=\"font-awesome/css/font-awesome.css\" rel=\"stylesheet\"><!-- Main Inspinia CSS files--><link href=\"css/animate.css\" rel=\"stylesheet\">    <link href=\"css/style.css\" rel=\"stylesheet\"><!-- ControllerAs syntax--><!-- Main controller with serveral data used in Inspinia theme on diferent view--></head><body ng-controller=\"MainCtrl as main\"><!-- Wrapper--><div id=\"wrapper\"><!-- Navigation--><div ng-include=\"'partials/common/navigation'\"></div><!-- Page wraper--><!-- ng-class with current state name give you the ability to extended customization your view--><div id=\"page-wrapper\" class=\"gray-bg {{$state.current.name}}\"><!-- Page wrapper--><div ng-include=\"'partials/common/topnavbar'\"></div><!-- Main view--><div ui-view=\"\"></div><!-- Footer--><div ng-include=\"'partials/common/footer'\"></div></div><!-- End page wrapper--></div><!-- End wrapper--><!-- jQuery and Bootstrap--><script src=\"components/jquery/jquery-2.1.1.min.js\"></script><script src=\"components/plugins/jquery-ui/jquery-ui.js\"></script><script src=\"components/bootstrap/bootstrap.min.js\"></script><!-- MetsiMenu--><script src=\"components/plugins/metisMenu/jquery.metisMenu.js\"></script><!-- Peace JS--><script src=\"components/plugins/pace/pace.min.js\"></script><!-- SlimScroll--><script src=\"components/plugins/slimscroll/jquery.slimscroll.min.js\"></script><!-- Custom and plugin javascript--><script src=\"components/inspina/inspina.js\"></script><!-- RequireJS entry point--><script src=\"bower_components/requirejs/require.js\" data-main=\"js/dependencies.js\"></script></body></html>");
}]);
